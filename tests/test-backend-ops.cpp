...
// Conv_2D test cases
 ...
 // A deep layer of a ConvNet, several images in the batch
    ...
    // Qwen QSA: 256/256, gqa 12, budget 2048. One query row per tile, one and two sequences.
    ...
    test_cases.emplace_back(new test_flash_attn_ext(256, 256, 2, {12, 1}, 8192, 1, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, true, false,  256));
    ...
    // More than one query row per block: the gather does not apply, the dense path must still be correct.

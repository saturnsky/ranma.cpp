...
The numbers of this fork against upstream: the release rows of the latest snapshot first, then the full set,
measured once at ranma_20260922 and not repeated for every release. The feature pages describe what
...
`llama-bench` PP512 and TG128 in t/s at the depth after the `@` on the Radeon AI PRO R9700 with 128 GB of host
memory, exclusive expert cache of 20480 MiB, in the configuration of the "R9700, 128 GB" row under "By system"
of each model: with prefill swap for Qwen3.8-Flash-Next UD-Q4_K_XL, without it for DeepSeek V4 Flash
UD-IQ3_XXS. One process per model and release, same machine and protocol as below.
The earlier rows are the ones in the tables below. "ranma_20260924" was measured on 2026-09-24 at `f10863821`, the
parent of this commit, on upstream `ec5a12b85`; "ranma_20260922" is `e48103e1e` on upstream `aa39d7a3e`, so the
difference also contains the 86 upstream commits between the two bases. Switches whose default changed in
between are at their new default.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| upstream `ec5a12b85`, `-ncmoe 35` | 333 | 327 | 320 | 314 | 306 | 15.6 | 15.4 | 15.2 | 14.1 | 13.0 | 29.9 / 80.7 |
| ranma_20260917 (reference, see below)<br>on upstream `093a2f86c` | 948 | 953 | 916 | 786 | 644 | 38.2 | 37.8 | 37.4 | 31.9 | 26.8 |  |
| ranma_20260922<br>on upstream `aa39d7a3e` | 1014 | 989 | 949 | 844 | 692 | 49.7 | 48.4 | 47.9 | 46.9 | 44.8 | 29.1 / 78.2 |
| ranma_20260924<br>on upstream `ec5a12b85` | 1166 | 1103 | 1059 | 930 | 764 | 50.2 | 49.5 | 49.5 | 48.5 | 47.0 | 29.1 / 78.2 |
| 20260922 against 20260917 | +7.0 % | +3.7 % | +3.6 % | +7.3 % | +7.5 % | +30.1 % | +28.1 % | +28.2 % | +47.0 % | +67.5 % |  |
| 20260924 against 20260922 | +14.9 % | +11.6 % | +11.6 % | +10.2 % | +10.5 % | +1.0 % | +2.2 % | +3.3 % | +3.4 % | +4.9 % |  |
| 20260924 against upstream | x3.50 | x3.37 | x3.31 | x2.96 | x2.50 | x3.23 | x3.22 | x3.25 | x3.44 | x3.61 |  |

DeepSeek V4 Flash UD-IQ3_XXS (the upstream row stops at depth 8192, see its section below; ranma_20260917 had
no DeepSeek row):

| | PP512 @0 | PP512 @4096 | PP512 @8192 | PP512 @32768 | PP512 @65536 | TG128 @0 | TG128 @4096 | TG128 @8192 | TG128 @32768 | TG128 @65536 | VRAM / host |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| upstream `ec5a12b85`, `-ncmoe 35` | 245 | 225 | 206 | - | - | 10.0 | 9.9 | 9.8 | - | - | 27.8 / 98.7 |
| ranma_20260922<br>on upstream `aa39d7a3e` | 310 | 276 | 255 | 161 | 108 | 31.8 | 30.8 | 30.9 | 29.7 | 28.1 | 27.9 / 90.3 |
| ranma_20260924<br>on upstream `ec5a12b85` | 343 | 302 | 275 | 211 | 168 | 32.4 | 31.6 | 31.4 | 30.1 | 28.3 | 28.0 / 90.5 |
| 20260924 against 20260922 | +10.6 % | +9.5 % | +7.8 % | +31.2 % | +55.6 % | +1.8 % | +2.7 % | +1.6 % | +1.5 % | +0.7 % |  |
| 20260924 against upstream | x1.40 | x1.34 | x1.33 | - | - | x3.25 | x3.19 | x3.20 | - | - |  |

The change rows compare each release with the one before it; the last row gives this release as a multiple
of upstream `ec5a12b85`, the base of this release, measured on 2026-09-24 with the upstream placement and
depths of the sections below (DeepSeek to depth 8192). Its rows are within 3 % of the `aa39d7a3e` rows below.
The ranma_20260917 row (`70dd001c2`) is quoted from the benchmark page of that snapshot and is a reference,
not a like-for-like row: it used the same machine, command and depth order, but a budget of 20000 MiB, no
`--poll 0`, and no idle gap between its 24 processes, whose repeats drifted by up to 3.9 % on PP512.
...
(`amdhip64_7.dll` 10.0.3581.0, the runtime DLLs shipped next to the binaries; the same runtime for the
2026-09-24 rows). The GPU runs with a -30 % power limit and a 0 mV voltage offset for every measurement here, and headless (no display attached; the CPU's integrated GPU drives
...
that snapshot (`e48103e1e`). The upstream rows of "This release" above are `ec5a12b85`, built the same way.

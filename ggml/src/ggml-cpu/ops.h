...
void ggml_compute_forward_top_k_block(const struct ggml_compute_params * params, struct ggml_tensor * dst);
...
void ggml_compute_forward_relu_sum_heads(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_dsv4_hc_post(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_dsv4_hc_coef(const struct ggml_compute_params * params, struct ggml_tensor * dst);
